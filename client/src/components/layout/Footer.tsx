      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/privacy-policy.pdf" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white text-sm transition-colors">Privacy Policy</a></li>
              <li><a href="/terms-of-service.pdf" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white text-sm transition-colors">Terms of Service</a></li>
            </ul>
          </div>
        </div>
