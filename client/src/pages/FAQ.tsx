...
export default function FAQ() {
  const faqs = [
    { q: "Is ApplyNiro free?", a: "For early access we're offering free trials to early users. Final pricing will be announced soon." },
    { q: "How does ApplyNiro access my LinkedIn account?", a: "We use secure OAuth where available to read your feed and identify posts that match your preferences. If an API is not available, we'll request your permission and explain any alternative connection method." },
    { q: "Will ApplyNiro send messages on my behalf?", a: "ApplyNiro can draft and queue messages using templates you configure. You can choose to review and approve sends, or enable semi-automatic sending with limits to prevent over-messaging." },
    ...
    { q: "When will ApplyNiro launch?", a: "We'll notify waitlist members first. Join now for priority access and the AI CV chatbot trial." },
    { q: "Who should use ApplyNiro?", a: "Fresh grads, early-career professionals, and anyone who wants to scale their application volume without losing personalization." },
  ];
    ...
    <Layout>
      <section className="pt-16 pb-24">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl">
          ...
          <p className="text-white/60 text-center mb-12">Everything you need to know about ApplyNiro.</p>
